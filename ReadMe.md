...
- `logs/word_frequency.log` - логи выполнения

## Примечания

- Первое слово пропускается (нет предыдущего)
- Слова чувствительны к регистру
- SHA-256 хэш должен заканчиваться на символ 0-7
- Результаты сортируются по убыванию частоты
